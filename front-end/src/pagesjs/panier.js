document.addEventListener("DOMContentLoaded", function () {
  ...
  let produitRecup = localStorage.getItem("Image");
  let referenceRecup = localStorage.getItem("Name");
  let quantityRecup = localStorage.getItem("Quantité");
  let prixRecup = localStorage.getItem("Prix");
  let montantTotal = localStorage.getItem("Montant");
  ...
  // let nameClient = document.querySelector("#nomClient");
